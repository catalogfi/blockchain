...
type MockIndexerClient struct {
	FuncGetAddressTxs     func(context.Context, btcutil.Address) ([]Transaction, error)
	FuncGetUTXOs          func(context.Context, btcutil.Address) (UTXOs, error)
	FuncGetTipBlockHeight func(ctx context.Context) (uint64, error)
	FuncGetTx             func(context.Context, string) (Transaction, error)
	FuncSubmitTx          func(ctx context.Context, tx *wire.MsgTx) error
	FuncFeeEstimate       func(ctx context.Context) (FeeSuggestion, error)
}

func (client MockIndexerClient) GetAddressTxs(ctx context.Context, address btcutil.Address) ([]Transaction, error) {
	return client.FuncGetAddressTxs(ctx, address)
}

func (client MockIndexerClient) GetUTXOs(ctx context.Context, address btcutil.Address) (UTXOs, error) {
...
func (client MockIndexerClient) GetTx(ctx context.Context, txid string) (Transaction, error) {
...
func (client MockIndexerClient) FeeEstimate(ctx context.Context) (FeeSuggestion, error) {
