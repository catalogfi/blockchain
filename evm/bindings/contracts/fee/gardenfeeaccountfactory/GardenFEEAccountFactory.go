...
func (_GardenFEEAccountFactory *GardenFEEAccountFactoryTransactor) CreateAndClaim(opts *bind.TransactOpts, amount *big.Int, nonce *big.Int, htlcs []GardenFEEAccountHTLC, secrets [][]byte, funderSig []byte, recipientSig []byte) (*types.Transaction, error) {
...
//
// Solidity: function createAndClaim(uint256 amount, uint256 nonce, (bytes32,uint256,uint256,uint256)[] htlcs, bytes[] secrets, bytes funderSig, bytes recipientSig) returns()
func (_GardenFEEAccountFactory *GardenFEEAccountFactorySession) CreateAndClaim(amount *big.Int, nonce *big.Int, htlcs []GardenFEEAccountHTLC, secrets [][]byte, funderSig []byte, recipientSig []byte) (*types.Transaction, error) {
...
//
// Solidity: function createAndClaim(uint256 amount, uint256 nonce, (bytes32,uint256,uint256,uint256)[] htlcs, bytes[] secrets, bytes funderSig, bytes recipientSig) returns()
func (_GardenFEEAccountFactory *GardenFEEAccountFactoryTransactorSession) CreateAndClaim(amount *big.Int, nonce *big.Int, htlcs []GardenFEEAccountHTLC, secrets [][]byte, funderSig []byte, recipientSig []byte) (*types.Transaction, error) {
	return _GardenFEEAccountFactory.Contract.CreateAndClaim(&_GardenFEEAccountFactory.TransactOpts, amount, nonce, htlcs, secrets, funderSig, recipientSig)
}
