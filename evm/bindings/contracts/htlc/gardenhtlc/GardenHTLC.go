...
func (_GardenHTLC *GardenHTLCCaller) InstantRefundDigest(opts *bind.CallOpts, orderID [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _GardenHTLC.contract.Call(opts, &out, "instantRefundDigest", orderID)
...
//
// Solidity: function instantRefundDigest(bytes32 orderID) view returns(bytes32)
func (_GardenHTLC *GardenHTLCSession) InstantRefundDigest(orderID [32]byte) ([32]byte, error) {
	return _GardenHTLC.Contract.InstantRefundDigest(&_GardenHTLC.CallOpts, orderID)
}

// InstantRefundDigest is a free data retrieval call binding the contract method 0x4882a380.
//
// Solidity: function instantRefundDigest(bytes32 orderID) view returns(bytes32)
func (_GardenHTLC *GardenHTLCCallerSession) InstantRefundDigest(orderID [32]byte) ([32]byte, error) {
	return _GardenHTLC.Contract.InstantRefundDigest(&_GardenHTLC.CallOpts, orderID)
}
...
func (_GardenHTLC *GardenHTLCTransactor) InitiateOnBehalf(opts *bind.TransactOpts, initiator common.Address, redeemer common.Address, timelock *big.Int, amount *big.Int, secretHash [32]byte) (*types.Transaction, error) {
	return _GardenHTLC.contract.Transact(opts, "initiateOnBehalf", initiator, redeemer, timelock, amount, secretHash)
}

// InitiateOnBehalf is a paid mutator transaction binding the contract method 0x13d4a787.
//
// Solidity: function initiateOnBehalf(address initiator, address redeemer, uint256 timelock, uint256 amount, bytes32 secretHash) returns()
func (_GardenHTLC *GardenHTLCSession) InitiateOnBehalf(initiator common.Address, redeemer common.Address, timelock *big.Int, amount *big.Int, secretHash [32]byte) (*types.Transaction, error) {
	return _GardenHTLC.Contract.InitiateOnBehalf(&_GardenHTLC.TransactOpts, initiator, redeemer, timelock, amount, secretHash)
}

// InitiateOnBehalf is a paid mutator transaction binding the contract method 0x13d4a787.
//
// Solidity: function initiateOnBehalf(address initiator, address redeemer, uint256 timelock, uint256 amount, bytes32 secretHash) returns()
func (_GardenHTLC *GardenHTLCTransactorSession) InitiateOnBehalf(initiator common.Address, redeemer common.Address, timelock *big.Int, amount *big.Int, secretHash [32]byte) (*types.Transaction, error) {
	return _GardenHTLC.Contract.InitiateOnBehalf(&_GardenHTLC.TransactOpts, initiator, redeemer, timelock, amount, secretHash)
}
...
// FilterInitiated is a free log retrieval operation binding the contract event 0x9b4a77f5bf15d4c0a5a0c2f4908723b76cf0a805e93f12819e4ceeedf35e2ed4.
//
// Solidity: event Initiated(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, address initiator, address redeemer)
...
// WatchInitiated is a free log subscription operation binding the contract event 0x9b4a77f5bf15d4c0a5a0c2f4908723b76cf0a805e93f12819e4ceeedf35e2ed4.
//
// Solidity: event Initiated(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, address initiator, address redeemer)
...
// ParseInitiated is a log parse operation binding the contract event 0x9b4a77f5bf15d4c0a5a0c2f4908723b76cf0a805e93f12819e4ceeedf35e2ed4.
//
// Solidity: event Initiated(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, address initiator, address redeemer)
...
// FilterRedeemed is a free log retrieval operation binding the contract event 0x5f3065a90508a851878babd768d4d427818687dc369f67ad923754a495bba2a6.
//
// Solidity: event Redeemed(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, bytes secret, address initiator, address redeemer)
...
// WatchRedeemed is a free log subscription operation binding the contract event 0x5f3065a90508a851878babd768d4d427818687dc369f67ad923754a495bba2a6.
//
// Solidity: event Redeemed(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, bytes secret, address initiator, address redeemer)
...
// ParseRedeemed is a log parse operation binding the contract event 0x5f3065a90508a851878babd768d4d427818687dc369f67ad923754a495bba2a6.
//
// Solidity: event Redeemed(bytes32 indexed orderID, bytes32 indexed secretHash, uint256 amount, bytes secret, address initiator, address redeemer)
